...
ChatBot::ChatBot(const ChatBot &source) {  
    ...
    std::cout << "Copying content of object to " << this << std::endl; 
}
//Rule3:copy assignment operator
ChatBot &ChatBot::operator=(const ChatBot &source) {  
    std::cout << "Assigning content of object to " << this << std::endl;
    if(this == &source) {
        return *this;
    }
    delete _image;
